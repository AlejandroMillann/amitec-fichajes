...
export function FichajeButton({ status, onPress, disabled }: FichajeButtonProps) {
  ...
  return (
    <div className="relative flex items-center justify-center" style={{ width: 280, height: 280 }}>
      ...
      {/* Outermost ring — always visible, very subtle */}
      <div
      ...
      {/* Animated pulse ring — visible when working/paused */}
      <AnimatePresence>
        {config.pulse && (
          <>
            <motion.div
            ...
            <motion.div
              ...
              style={{
                width: 228,
                height: 228,
                border: `1.5px solid ${config.ringColorStrong}`,
              }}
            />
          </>
        )}
      ...
      <motion.button
        ...
        style={{
          width: 200,
          height: 200,
          boxShadow: `0 0 40px ${config.glow}, 0 0 80px ${config.glow.replace("0.5", "0.2")}, 0 8px 32px rgba(0,0,0,0.4)`,
        }}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="text-center">
              <p className="text-white font-bold text-[11px] tracking-[0.12em]">
                {config.label}
              </p>
